        # Metaregression: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metaregression.git

        ## Objective

        MetaRegression is a world-first browser-based meta-regression tool supporting continuous and categorical moderators, bubble plots, and residual heterogeneity decomposition.
        ...
        - Code: https://github.com/mahmood726-cyber/metaregression.git
        - Dashboard: https://mahmood726-cyber.github.io/metaregression/
